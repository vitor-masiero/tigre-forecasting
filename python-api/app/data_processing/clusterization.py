...
class DataClusterization:
    ...
    def obter_metricas(df, sku):
        ...
        if prop_zeros > 0.25:
            ...
            forca_sazonalidade = DataClusterization.calcular_forca_sazonalidade(df_qtd_ajustado)
        else:
    ...
    def clusterizar_skus(df):
        ...
        features = ['media', 'coeficiente_variacao', 'tendencia', 'forca_sazonalidade', 'proporcao_zeros']
